...
Il progetto contiene già le basi per la scansione guidata delle sei facce con fotocamera posteriore, il parsing delle mosse, il tracciamento MediaPipe delle mani, il riconoscimento `R/L/U/D/F/B`, la classificazione Cross/F2L/OLL/PLL e il replay virtuale. Questi moduli non vanno rimossi durante le pulizie, anche quando non sono ancora esposti nell’interfaccia.
